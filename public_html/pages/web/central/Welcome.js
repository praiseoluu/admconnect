/**
 * Adamawa Konect — Welcome Page (Central)
 * ============================================================
 * Route: /central/welcome
 *
 ...
 *     router.replace('/central/welcome')
 *   Otherwise →
 *     router.replace('/central/home')
 *
...
export default class WelcomePage extends WebLayout {
  ...
  _markWelcomeSeen() {
    try {
      ...
      // Non-critical — router guard handles retry on next login
    }
  }
