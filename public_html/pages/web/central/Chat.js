...
export default class ChatPage extends WebLayout {
  ...
  _createMessageEl(msg) {
    ...
    wrapper.innerHTML = `
      <div class="chat-msg__avatar">${!isOwn ? `<a class="chat-msg__name" href="/central/u/${this.esc(msg.userName)}">${avatarHtml}</a>` : avatarHtml}</div>
      <div class="chat-msg__content">
        ${!isOwn ? `<a class="chat-msg__name" href="/central/u/${this.esc(msg.userName)}">${this.esc(msg.userName)}</a>` : ''}
