/**
 * Adamawa Konect — Public User Profile Page (North)
 * ============================================================
 * Route:     /north/u/:username
 * Auth:      Not required
 *
 * Shows the hero, stats and reels grid for any public citizen
 * profile in the North zone. Private profiles render a minimal
 * locked view instead.
 *
 * Data flow:
