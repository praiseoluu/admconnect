/**
 * Adamawa Konect — Public User Profile Page (South)
 * ============================================================
 * Route:     /south/u/:username
 * Auth:      Not required
 *
 * Shows the hero, stats and reels grid for any public citizen
 * profile in the South zone. Private profiles render a minimal
 * locked view instead.
 *
 * Data flow:
