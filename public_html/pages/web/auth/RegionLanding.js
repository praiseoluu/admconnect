/**
 * Adamawa Konect — Region Landing Page
 * ============================================================
 * Shared landing page used by all three region routes:
 *   /north   → Adamawa North Connect
 *   /central → Adamawa Central Connect
 *   /south   → Adamawa South Connect
 *
...
export default class RegionLandingPage extends Component {
          ...
          <div class="landing__hero-inner">
            <div class="landing__hero-content">
              <h1 class="landing__hero-heading" id="rl-hero-heading">
                ${region ? region.title : 'Adamawa Konect'}
              </h1>
    ...
    afterMount() {
        ...
        sessionStorage.setItem('adamawaRegion', regionId);
